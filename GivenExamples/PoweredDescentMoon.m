...
disp('Orbital velocity (km/s) at 20 km of elliptical orbit with 100 km apolune and 
and 20 km perilune');
...
y0braking=[V0 0 h2 0 m0]; %% starting values for speed-flight path angle-altitude-
ground distance-mass
...
y0descent=[y1(end,1) y1(end,2) y1(end,3) y1(end,4) y1(end,5)]; %% starting values 
for speed-flight path angle-altitude-ground distance-mass
